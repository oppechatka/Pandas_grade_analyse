...
chemso = {"Задание (Avg)": 0.006,
          "Итоговый контроль 1: Итоговый контроль (прокторинг)": 0.01,
          "Итоговый контроль 2: Итоговый контроль (УрФУ)": 0.01,
          "Итоговый контроль 3: Итоговый контроль (УрФУ, пересдача)": 0.01,
          "Итоговый контроль (Avg)": 0.004,
          "Grade Percent": 1,
          "Columns_for_order": ["Задания (проходной балл 40)",
                                "Итоговый контроль (прокторинг)",
                                "Итоговый контроль (УрФУ)",
                                "Итоговый контроль (УрФУ, пересдача)",
                                "Экзамен (проходной балл 40)",
                                "Итоговый балл"],
          "Columns_for_report": ["Email",
                                 "Задание (Avg)",
                                 "Итоговый контроль 1: Итоговый контроль (прокторинг)",
                                 "Итоговый контроль 2: Итоговый контроль (УрФУ)",
                                 "Итоговый контроль 3: Итоговый контроль (УрФУ, пересдача)",
                                 "Итоговый контроль (Avg)",
                                 "Grade Percent"]
          }
...
its = {"Тестовые задания (Avg)": 0.004,  # Требует доработки после добавления экзамена
       "Grade": 0.01,
       "Columns_for_order": ["Тесты (проходной балл 40)",
                             "Итоговый балл"],
       "Columns_for_report": ["Email",
