...
hist = {"Тестовое задание (Avg)": 0.003,
        ...
        "Итоговый контроль": 0.004, # Закрытая копия курса
        # "Итоговый контроль (Avg)": 0.004,   # Открытая копия курса
        "Grade Percent": 1,
        "Columns_for_order": ["Тесты (проходной балл 40)",
                              "Учебные задания (проходной балл 40)",
                              "Экзамен (проходной балл 40)",
        ...
        "Columns_for_report": ["Email",
                               "Тестовое задание (Avg)",
                               "Учебное задание (Avg)",
                               "Итоговый контроль",   # Закрытая копия курса
                               # "Итоговый контроль (Avg)",   # Открытая копия курса
                               "Grade Percent"]
        }
